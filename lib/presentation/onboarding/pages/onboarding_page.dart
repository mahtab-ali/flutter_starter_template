...
import 'package:starter_template_flutter/presentation/onboarding/bloc/onboarding_event.dart';
import 'package:starter_template_flutter/presentation/onboarding/bloc/onboarding_state.dart';
...
import 'package:starter_template_flutter/presentation/onboarding/widgets/onboarding_card.dart';

import '../../../presentation/common/widgets/app_bar/app_bar_actions.dart';
...
class _OnboardingPageState extends State<OnboardingPage>
  ...
  // Navigates to the next page respecting RTL direction
  void _goToNextPage(bool isRTL) {
    if (_pageController.page == null) return;

    final currentPage = _pageController.page!.round();
    final totalPages =
        context.read<OnboardingBloc>().state is OnboardingInProgress
            ? (context.read<OnboardingBloc>().state as OnboardingInProgress)
                .totalPages
            : 3;

    if ((isRTL && currentPage > 0) ||
        (!isRTL && currentPage < totalPages - 1)) {
      _pageController.animateToPage(
        isRTL ? currentPage - 1 : currentPage + 1,
        duration: UniversalConstants.animationDurationSlow,
  ...
  Widget _buildNavigationArea(
    ...
    // Check if we're on the last page, respecting RTL direction
    final isLastPage = isRTL ? currentPage == 0 : currentPage == totalPages - 1;
